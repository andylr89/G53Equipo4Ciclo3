...
<body>
	...
	<div style="padding-left: 5px">
		<h1>
			<i class="fas fa-sync"></i> Datos a actualizar del Proveedor </h1>
		<div class="container">


			<div id="error" class="alert alert-danger visually-hidden"
				role="alert">Error al actualizar el proveedor, verifique que el NIT nombre dados sean validos</div>
