	...
	function loadventas() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState === 4 && xmlhttp.status === 200) {
				...
				var tbltop = "<table class='table table-dark table-striped'><tr><th>Cedula</th><th>Nombre</th><th>Valor_Total_Ventas</th></tr>";
				var main = "";
				for (i = 0; i < ventas.length; i++) {
					main += "<tr><td>" + ventas[i].cedula_cliente
							+ "</td><td>" + ""
// 							for(i = 0; i < clientes.length; i++){
// 								main += clientes[i].nombre_cliente}
...
<body>
	...
	<div style="padding-left: 5px;">
		...
		<h2><i class="fas fa-th-list"></i> Ventas por Cliente </h2>
			<div class="container">
				<div class="row">
